...
from app.core.exceptions.exceptions import DatabaseException, InternalServerErrorException, InvalidCredentialsException
...
async def validation_exception_handler(request: Request, exc: RequestValidationError):
    ...
    return JSONResponse(
        status_code=status.HTTP_400_BAD_REQUEST, content={"message": "Validation error", "errors": errors}
    )
...
def register_exception_handlers(app: FastAPI):
    ...
    # this should be the last one to avoid overriding other handlers
